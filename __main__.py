...
task = aws.ecs.TaskDefinition(project_stack,
    ...
    task_role_arn=f'arn:aws:iam::{account_id}:role/AWSECSTaskRole',
...
event_rule = aws.cloudwatch.EventRule(project_stack,
    ...
    role_arn=f'arn:aws:iam::{account_id}:role/ecsTaskExecutionRole',
    is_enabled=True,
    tags={'group': 'sdsnv2020', 'stack': stack},
)
...
event_target = aws.cloudwatch.EventTarget(project_stack,
    ...
    role_arn=f'arn:aws:iam::{account_id}:role/ecsEventsRole',
